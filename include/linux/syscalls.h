...
asmlinkage long sys_rmtag(const char __user *filename, const char __user **tag, unsigned int size);
...
asmlinkage long sys_distag(unsigned long ino, char __user **buf, unsigned long size, unsigned long tag_offset);
